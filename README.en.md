...
The client has been tested against a DH2300 running UGOS Pro 1.18 in header token mode. URL token mode is implemented from the observed protocol but has not been tested against a device.
